...
public class Example6 {
    public static void main(String[] args) throws IOException {
        ...
        try {
            in = new FileReader("src\\lr8\\lr8_1\\_6\\MyFile1.txt"); // файл для чтения
            out = new FileWriter("src\\lr8\\lr8_1\\_6\\MyFile2.txt", true); // файл для записи
